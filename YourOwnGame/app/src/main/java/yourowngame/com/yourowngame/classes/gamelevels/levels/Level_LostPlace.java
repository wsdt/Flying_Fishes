...
public class Level_LostPlace extends Level implements IBackground {
    ...
    protected void determineBackgroundLayers() {
        ...
        * - Add layers acc. to the desired order (first add() is the lowest layer etc.)*/
        this.getAllBackgroundLayers().add(new BackgroundLayer_staticBgImg(LevelManager.getBackgroundManager(), R.color.colorPrimary, "Sky", DEFAULT_BG_SPEED));
    ...
    protected void determineAllEnemies() { //Only exception (initialize() here instead of in obj constr, because of createRandomEnemies())
        ...
        rocketEnemyManager.createRandomEnemies(8);
    ...
    protected void determineFruits() {
        ...
        this.getAllFruits().addAll(Arrays.asList(FruitMgr.createMeloon(), FruitMgr.createMeloon()));
    }
