...
public class Level_SummerSky extends Level {
    ...
    public Level_SummerSky(@NonNull DrawableSurfaceActivity activity, @NonNull Point worldMapPosition) {
    ...
    protected void determineBackgroundLayers() {
        ...
        allBgs.add(new BL_FlyingElements(this.getDrawableSurfaceActivity(), new int[]{R.drawable.bg_layer_flying_elements_clouds_1, R.drawable.bg_layer_flying_elements_clouds_2, R.drawable.bg_layer_flying_elements_clouds_3}, 5));
    ...
    protected void determineAllEnemies() { //Only exception (initialize() here instead of in obj constr, because of createRandomEnemies())
        ...
        allEnemies.addAll(EnemyMgr.createRandomEnemies(this.getDrawableSurfaceActivity(), Enemy_Happen.class, 2));

        /*Initializing Rocket-Enemy */
        allEnemies.addAll(EnemyMgr.createRandomEnemies(this.getDrawableSurfaceActivity(), Enemy_Rocketfish.class, 2));

        /* Initializing Spawn-Enemies */
        allEnemies.addAll(EnemyMgr.createRandomEnemies(this.getDrawableSurfaceActivity(), Enemy_Boba.class, 2));
