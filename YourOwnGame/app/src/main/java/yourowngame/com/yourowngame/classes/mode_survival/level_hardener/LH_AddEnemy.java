package yourowngame.com.yourowngame.classes.mode_survival.level_hardener;
...
import yourowngame.com.yourowngame.classes.mode_survival.Level_Survival;
...
public class LH_AddEnemy implements ISurvival_Hardener_Base {
    ...
    public void execute(@NonNull Level_Survival levelSurvival) {
        if (Level_Survival.SUPPORTED_ENEMIES != null && Level_Survival.SUPPORTED_ENEMIES.length > 0) {
            levelSurvival.getCurrentEnemies().add(
                    EnemyMgr.createRandomEnemy(levelSurvival.getActivity(),
