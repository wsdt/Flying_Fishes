...
import static yourowngame.com.yourowngame.classes.manager.interfaces.ISharedPrefStorageMgr.*;
...
public class SharedPrefStorageMgr {
    ...
    public void saveNewHighscoreEntry(int points) {
        ...
        this.getSharedPreferences().edit().putInt(SP_ENTRY_PREFIX+"_"+ RandomMgr.getRandomInt(0, 999999999),points).apply();
    }
